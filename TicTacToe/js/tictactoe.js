...
//This functions is for placing an x or o in the a square.
function placeXOrO(squareNumber) {
    //This condition ensures a squares hasn't been selected already.
    ...
    if (!selectedSquares.some(element => element.includes(squareNumber))) {
        ...
        if (activePlayer === 'X') {
            //If activePlayer is equal to 'X', the x.ping is placed in HTML
            select.style.backgroundImage = 'url("images/x.png")';
            //Active player may only be 'X' or 'O' so, if not 'X' it must be 'O'
        } else{
            //If activePlayer is equal to 'O', the o.ping is placed in the HTML
            select.style.backgroundImage = 'url("images/o.png")';
        }
        //squareNumber and activePlayer are concatenated together and added to array.
        selectedSquares.push(squareNumber + activePlayer);
        //This calls a function to check for changing the active player.
        checkWinConditions();
        ...
        //Tis condition checks to see if it is the computers turn.
        if (activePlayer === 'O') {
...
function checkWinConditions() {
    ...
    //9 squares are selected the code executes.
        ...
        //This function plays the tie games sound.
        audio('./media/tie.mp3');
...
function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
    ...
    function animateLineDrawing() {
        ...
        if (x1 <= x2 && y1 <= y2) {
            ...
            if (y < x2) { x += 10; }
            //The condition adds 10 to the previous end y endpoint.
            if (y < y2) { y += 10; }
